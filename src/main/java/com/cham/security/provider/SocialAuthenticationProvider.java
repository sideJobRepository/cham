...
public class SocialAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        AccessTokenResponse accessToken = socialService.getAccessToken(authorizeCode,loginUrl);
    ...
    private SocialService getSocialServiceByLoginUrl(String loginUrl) {
        return switch (loginUrl) {
            case "/cham/kakao-login", "/cham/next/kakao-login" -> kakaoService;
            case "/cham/naver-login", "/cham/next/naver-login" -> naverService;
